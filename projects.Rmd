...
# Codon Bias of ER associated RNA

<p style="text-align: justify"> 
Markus Landthaler and I are investigating the Codon usage bias of mRNA associated with Endoplasmic Reticulum (ER). Specifically, we are interested in certain sites of mRNA that interacts with HDLBP, a RNA-binding protein that regulates the translation of mRNA around ER. 
</p>

<p style="text-align: justify">
We have recently started to implement custom scripts to analyze codon usage as well as to investigate the "codon pair" usage which counts pairs of codons.
</p>
