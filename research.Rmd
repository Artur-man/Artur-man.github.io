...
Computing is an essential part of statistical analysis where building appealing models of data as well as visualizing such data is crucial. A large proportion of my work include building and designing data structures for capturing essential information from the data to either summarize or visualize complex information. 
